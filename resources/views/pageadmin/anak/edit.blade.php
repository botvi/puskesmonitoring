                ...
                <form action="{{ route('anak.update', $anak->id) }}" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control @error('orang_tua_id') is-invalid @enderror" id="orang_tua_id"
                            ...
                            @foreach ($orangTuas as $orangTua)
                                <option {{ old('orang_tua_id', $anak->orang_tua_id) == $orangTua->id ? 'selected' : '' }}
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control @error('nama_lengkap') is-invalid @enderror" id="nama_lengkap"
                            name="nama_lengkap" required type="text"
                            value="{{ old('nama_lengkap', $anak->nama_lengkap) }}">
                        @error('nama_lengkap')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control @error('jenis_kelamin') is-invalid @enderror" id="jenis_kelamin"
                            ...
                            <option {{ old('jenis_kelamin', $anak->jenis_kelamin) == 'Laki-laki' ? 'selected' : '' }}
                                value="Laki-laki">Laki-laki</option>
                            <option {{ old('jenis_kelamin', $anak->jenis_kelamin) == 'Perempuan' ? 'selected' : '' }}
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control @error('nomor_identitas_anak') is-invalid @enderror"
                            ...
                            value="{{ old('nomor_identitas_anak', $anak->nomor_identitas_anak) }}">
