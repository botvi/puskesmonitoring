...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Blog / Update</h4>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('blog.update', ['id' => $blog->id]) }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="title" required type="text" value="{{ $blog->title }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group mb-5">
                        ...
                        <img alt="{{ $blog->title }}" class="img-fluid mt-3" src="{{ asset('Blog/' . $blog->image) }}"
                            style="width: 100px; height: 100px;">
                    </div>
                    <div class="form-group">
                        <label for="konten">Konten</label>
                        <textarea class="form-control" id="content" name="konten">{!! $blog->konten !!}</textarea>
                    </div>
                    <div class="mt-3">
